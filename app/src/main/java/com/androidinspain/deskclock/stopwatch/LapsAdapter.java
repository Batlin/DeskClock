...
package com.androidinspain.deskclock.stopwatch;
...
class LapsAdapter extends RecyclerView.Adapter<LapsAdapter.LapItemHolder> {
    ...
    public LapItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View v = mInflater.inflate(com.androidinspain.deskclock.R.layout.lap_view, parent, false /* attachToRoot */);
    ...
    String getShareText() {
        ...
        builder.append(mContext.getString(com.androidinspain.deskclock.R.string.sw_share_main, stopwatchTime));
        builder.append("\n");

        final List<Lap> laps = getLaps();
        if (!laps.isEmpty()) {
            // Add a header for lap times.
            builder.append(mContext.getString(com.androidinspain.deskclock.R.string.sw_share_laps));
            builder.append("\n");
    ...
    String formatLapNumber(int lapCount, int lapNumber) {
        if (lapCount < 10) {
            return mContext.getString(com.androidinspain.deskclock.R.string.lap_number_single_digit, lapNumber);
        } else {
            return mContext.getString(com.androidinspain.deskclock.R.string.lap_number_double_digit, lapNumber);
        }
    }
    ...
    static final class LapItemHolder extends RecyclerView.ViewHolder {
        ...
        LapItemHolder(View itemView) {
            ...
            lapTime = (TextView) itemView.findViewById(com.androidinspain.deskclock.R.id.lap_time);
            lapNumber = (TextView) itemView.findViewById(com.androidinspain.deskclock.R.id.lap_number);
            accumulatedTime = (TextView) itemView.findViewById(com.androidinspain.deskclock.R.id.lap_total);
        }
    }
}