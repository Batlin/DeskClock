...
import com.androidinspain.deskclock.RingtonePreviewKlaxon;
...
import com.androidinspain.deskclock.alarms.AlarmUpdateHandler;
import com.androidinspain.deskclock.data.DataModel;
import com.androidinspain.deskclock.provider.Alarm;
...
import static com.androidinspain.deskclock.ringtone.AddCustomRingtoneViewHolder.VIEW_TYPE_ADD_NEW;
...
public class RingtonePickerActivity extends BaseActivity
    ...
    public static Intent createAlarmRingtonePickerIntent(Context context, Alarm alarm) {
        return new Intent(context, RingtonePickerActivity.class)
                .putExtra(EXTRA_TITLE, com.androidinspain.deskclock.R.string.alarm_sound)
                ...
                .putExtra(EXTRA_DEFAULT_RINGTONE_NAME, com.androidinspain.deskclock.R.string.default_alarm_ringtone_title);
    }
    ...
    public static Intent createTimerRingtonePickerIntent(Context context) {
        ...
        return new Intent(context, RingtonePickerActivity.class)
                .putExtra(EXTRA_TITLE, com.androidinspain.deskclock.R.string.timer_sound)
                ...
                .putExtra(EXTRA_DEFAULT_RINGTONE_NAME, com.androidinspain.deskclock.R.string.default_timer_ringtone_title);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.androidinspain.deskclock.R.layout.ringtone_picker);
        ...
        final ItemAdapter.ItemViewHolder.Factory ringtoneFactory = new RingtoneViewHolder.Factory(inflater);
        final ItemAdapter.ItemViewHolder.Factory headerFactory = new HeaderViewHolder.Factory(inflater);
        final ItemAdapter.ItemViewHolder.Factory addNewFactory = new AddCustomRingtoneViewHolder.Factory(inflater);
        mRingtoneAdapter = new ItemAdapter<>();
        mRingtoneAdapter.withViewTypes(headerFactory, null, HeaderViewHolder.VIEW_TYPE_ITEM_HEADER)
        ...
        mRecyclerView = (RecyclerView) findViewById(com.androidinspain.deskclock.R.id.ringtone_content);
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            if (arguments.getBoolean(ARG_RINGTONE_HAS_PERMISSIONS)) {
                return new AlertDialog.Builder(getActivity())
                        .setPositiveButton(com.androidinspain.deskclock.R.string.remove_sound, okListener)
                        .setNegativeButton(android.R.string.cancel, null /* listener */)
                        .setMessage(com.androidinspain.deskclock.R.string.confirm_remove_custom_ringtone)
                        .create();
            } else {
                return new AlertDialog.Builder(getActivity())
                        .setPositiveButton(com.androidinspain.deskclock.R.string.remove_sound, okListener)
                        .setMessage(com.androidinspain.deskclock.R.string.custom_ringtone_lost_permissions)
                        .create();
            }
        }
    }
    ...
    private final class AddCustomRingtoneTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            return mContext.getString(com.androidinspain.deskclock.R.string.unknown_ringtone_title);
        }
