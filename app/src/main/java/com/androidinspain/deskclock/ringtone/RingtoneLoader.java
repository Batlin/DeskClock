...
import com.androidinspain.deskclock.data.CustomRingtone;
...
import static com.androidinspain.deskclock.Utils.RINGTONE_SILENT;
...
class RingtoneLoader extends AsyncTaskLoader<List<ItemAdapter.ItemHolder<Uri>>> {
    ...
    public List<ItemAdapter.ItemHolder<Uri>> loadInBackground() {
        ...
        itemHolders.add(new HeaderHolder(com.androidinspain.deskclock.R.string.your_sounds));
        ...
        itemHolders.add(new HeaderHolder(com.androidinspain.deskclock.R.string.device_sounds));
