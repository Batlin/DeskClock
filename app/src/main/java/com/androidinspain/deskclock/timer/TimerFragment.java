...
public final class TimerFragment extends DeskClockFragment {
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    fab.setContentDescription(fab.getResources().getString(com.androidinspain.deskclock.R.string.timer_stop));
                    break;
                case RESET:
                    if (animate) {
                    ...
                    fab.setContentDescription(fab.getResources().getString(com.androidinspain.deskclock.R.string.timer_start));
                    break;
                case PAUSED:
                    if (animate) {
    ...
    public void onUpdateFabButtons(@NonNull Button left, @NonNull Button right) {
        if (mCurrentView == mTimersView) {
            ...
            left.setContentDescription(left.getResources().getString(com.androidinspain.deskclock.R.string.timer_delete));
            left.setVisibility(VISIBLE);

            right.setClickable(true);
            right.setText(com.androidinspain.deskclock.R.string.timer_add_timer);
            right.setContentDescription(right.getResources().getString(com.androidinspain.deskclock.R.string.timer_add_timer));
            right.setVisibility(VISIBLE);

        } else if (mCurrentView == mCreateTimerView) {
            left.setClickable(true);
            left.setText(com.androidinspain.deskclock.R.string.timer_cancel);
            left.setContentDescription(left.getResources().getString(com.androidinspain.deskclock.R.string.timer_cancel));
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_stop, com.androidinspain.deskclock.R.string.label_deskclock);
                    if (currentTime > 0) {
                        mTimersView.announceForAccessibility(TimerStringFormatter.formatString(
                                context, com.androidinspain.deskclock.R.string.timer_accessibility_stopped, currentTime, true));
                    }
                    break;
                case PAUSED:
                case RESET:
                    DataModel.getDataModel().startTimer(timer);
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_start, com.androidinspain.deskclock.R.string.label_deskclock);
                    if (currentTime > 0) {
                        mTimersView.announceForAccessibility(TimerStringFormatter.formatString(
                                context, com.androidinspain.deskclock.R.string.timer_accessibility_started, currentTime, true));
                    }
                    break;
                case MISSED:
                case EXPIRED:
                    DataModel.getDataModel().resetOrDeleteTimer(timer, com.androidinspain.deskclock.R.string.label_deskclock);
                    break;
            }
            ...
            try {
                ...
                Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_create, com.androidinspain.deskclock.R.string.label_deskclock);
    ...
    public void onLeftButtonClick(@NonNull Button left) {
        if (mCurrentView == mTimersView) {
            ...
            left.announceForAccessibility(getActivity().getString(com.androidinspain.deskclock.R.string.timer_deleted));
            ...
            left.announceForAccessibility(getActivity().getString(com.androidinspain.deskclock.R.string.timer_canceled));
        }
    }
    ...
    private void animateTimerRemove(final Timer timerToRemove) {
        ...
        fadeOut.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_delete, com.androidinspain.deskclock.R.string.label_deskclock);
            }
        });
