...
public final class TimerService extends Service {
    ...
    private static final String ACTION_PREFIX = "com.androidinspain.deskclock.action.";
    ...
    public static final String EXTRA_TIMER_ID = "com.androidinspain.deskclock.extra.TIMER_ID";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            final int label = intent.getIntExtra(Events.EXTRA_EVENT_LABEL, com.androidinspain.deskclock.R.string.label_intent);
            switch (action) {
            ...
            switch (action) {
                case ACTION_SHOW_TIMER: {
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_show, label);
                    ...
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_start, label);
                    DataModel.getDataModel().startTimer(this, timer);
                    break;
                } case ACTION_PAUSE_TIMER: {
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_pause, label);
                    DataModel.getDataModel().pauseTimer(timer);
                    break;
                } case ACTION_ADD_MINUTE_TIMER: {
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_add_minute, label);
                    ...
                    Events.sendTimerEvent(com.androidinspain.deskclock.R.string.action_fire, label);
