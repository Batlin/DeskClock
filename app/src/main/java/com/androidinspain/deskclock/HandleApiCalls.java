...
import com.androidinspain.deskclock.alarms.AlarmStateManager;
import com.androidinspain.deskclock.controller.Controller;
...
import com.androidinspain.deskclock.timer.TimerFragment;
...
import static com.androidinspain.deskclock.provider.AlarmInstance.FIRED_STATE;
import static com.androidinspain.deskclock.provider.AlarmInstance.SNOOZE_STATE;
import static com.androidinspain.deskclock.uidata.UiDataModel.Tab.ALARMS;
import static com.androidinspain.deskclock.uidata.UiDataModel.Tab.TIMERS;
        ...
        protected Void doInBackground(Void... parameters) {
            ...
            if (searchMode == null && alarms.size() > 1) {
                ...
                final Intent pickSelectionIntent = new Intent(mContext,
                        ...
                        .putExtra(AlarmSelectionActivity.EXTRA_ALARMS, alarms.toArray(new Parcelable[alarms.size()]));
