...
package com.androidinspain.deskclock.data;
...
import com.androidinspain.deskclock.AlarmUtils;
import com.androidinspain.deskclock.Utils;
import com.androidinspain.deskclock.events.Events;
import com.androidinspain.deskclock.timer.ExpiredTimersActivity;
import com.androidinspain.deskclock.timer.TimerService;
...
class TimerNotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, List<Timer> unexpired) {
        ...
        if (count == 1) {
            if (running) {
                ...
                @DrawableRes final int icon1 = com.androidinspain.deskclock.R.drawable.ic_pause_24dp;
                ...
                @DrawableRes final int icon2 = com.androidinspain.deskclock.R.drawable.ic_add_24dp;
                ...
                @DrawableRes final int icon1 = com.androidinspain.deskclock.R.drawable.ic_start_24dp;
                ...
                @DrawableRes final int icon2 = com.androidinspain.deskclock.R.drawable.ic_reset_24dp;
            ...
            @DrawableRes final int icon1 = com.androidinspain.deskclock.R.drawable.ic_reset_24dp;
        ...
        if (Utils.isNOrLater()) {
            ...
            if (count == 1) {
                ...
                final String timeRemaining = TimerStringFormatter.formatTimeRemaining(context,
                        timer.getRemainingTime(), false);
                contentTextPreN = context.getString(com.androidinspain.deskclock.R.string.next_timer_notif, timeRemaining);
            } else {
    ...
    Notification buildHeadsUp(Context context, List<Timer> expired) {
        ...
        @DrawableRes final int icon1 = com.androidinspain.deskclock.R.drawable.ic_stop_24dp;
    ...
    Notification buildMissed(Context context, NotificationModel nm,
        ...
        if (count == 1) {
            ...
            if (TextUtils.isEmpty(timer.getLabel())) {
                ...
                stateText = res.getString(com.androidinspain.deskclock.R.string.missed_named_timer_notification_label,
                        timer.getLabel());
            }
    ...
    private RemoteViews buildChronometer(String pname, long base, boolean running,
        ...
        final RemoteViews content = new RemoteViews(pname, com.androidinspain.deskclock.R.layout.chronometer_notif_content);
