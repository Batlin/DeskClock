...
class StopwatchNotificationBuilder {
    ...
    public Notification build(Context context, NotificationModel nm, Stopwatch stopwatch) {
        @StringRes final int eventLabel = com.androidinspain.deskclock.R.string.label_notification;
        ...
        if (running) {
            ...
            if (DataModel.getDataModel().canAddMoreLaps()) {
                ...
                @DrawableRes final int icon2 = com.androidinspain.deskclock.R.drawable.ic_sw_lap_24dp;
            ...
            if (lapCount > 0) {
                ...
                final String lap = res.getString(com.androidinspain.deskclock.R.string.sw_notification_lap_number, lapNumber);
            ...
            content.setTextViewText(com.androidinspain.deskclock.R.id.state, res.getString(com.androidinspain.deskclock.R.string.swn_paused));
            content.setViewVisibility(com.androidinspain.deskclock.R.id.state, VISIBLE);
        }
