...
package com.androidinspain.deskclock.worldclock;
...
import com.androidinspain.deskclock.BaseActivity;
import com.androidinspain.deskclock.DropShadowController;
import com.androidinspain.deskclock.Utils;
import com.androidinspain.deskclock.actionbarmenu.MenuItemController;
import com.androidinspain.deskclock.actionbarmenu.MenuItemControllerFactory;
import com.androidinspain.deskclock.actionbarmenu.NavUpMenuItemController;
import com.androidinspain.deskclock.actionbarmenu.OptionsMenuManager;
import com.androidinspain.deskclock.actionbarmenu.SearchMenuItemController;
import com.androidinspain.deskclock.actionbarmenu.SettingsMenuItemController;
import com.androidinspain.deskclock.data.City;
...
public final class CitySelectionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.androidinspain.deskclock.R.layout.cities_activity);
        ...
        mCitiesList = (ListView) findViewById(com.androidinspain.deskclock.R.id.cities_list);
    ...
    public void onResume() {
        ...
        final View dropShadow = findViewById(com.androidinspain.deskclock.R.id.drop_shadow);
    ...
    private static final class CityAdapter extends BaseAdapter implements View.OnClickListener,
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case VIEW_TYPE_SELECTED_CITIES_HEADER:
                    if (view == null) {
                        view = mInflater.inflate(com.androidinspain.deskclock.R.layout.city_list_header, parent, false);
                    }
                    return view;
                ...
                case VIEW_TYPE_CITY:
                    ...
                    if (view == null) {
                        view = mInflater.inflate(com.androidinspain.deskclock.R.layout.city_list_item, parent, false);
                        final TextView index = (TextView) view.findViewById(com.androidinspain.deskclock.R.id.index);
                        final TextView name = (TextView) view.findViewById(com.androidinspain.deskclock.R.id.city_name);
                        final TextView time = (TextView) view.findViewById(com.androidinspain.deskclock.R.id.city_time);
                        final CheckBox selected = (CheckBox) view.findViewById(com.androidinspain.deskclock.R.id.city_onoff);
        ...
        public void onCheckedChanged(CompoundButton b, boolean checked) {
            ...
            if (checked) {
                ...
                b.announceForAccessibility(mContext.getString(com.androidinspain.deskclock.R.string.city_checked,
                        city.getName()));
            } else {
                mUserSelectedCities.remove(city);
                b.announceForAccessibility(mContext.getString(com.androidinspain.deskclock.R.string.city_unchecked,
                        city.getName()));
            }
        }
        ...
        public void onClick(View v) {
            final CheckBox b = (CheckBox) v.findViewById(com.androidinspain.deskclock.R.id.city_onoff);
    ...
    private final class SortOrderMenuItemController implements MenuItemController {
        ...
        private static final int SORT_MENU_RES_ID = com.androidinspain.deskclock.R.id.menu_item_sort;
        ...
        public void onCreateOptionsItem(Menu menu) {
            menu.add(NONE, com.androidinspain.deskclock.R.id.menu_item_sort, NONE, com.androidinspain.deskclock.R.string.menu_item_sort_by_gmt_offset)
        ...
        public void onPrepareOptionsItem(MenuItem item) {
            item.setTitle(DataModel.getDataModel().getCitySort() == DataModel.CitySort.NAME
                    ? com.androidinspain.deskclock.R.string.menu_item_sort_by_gmt_offset : com.androidinspain.deskclock.R.string.menu_item_sort_by_name);
        }
