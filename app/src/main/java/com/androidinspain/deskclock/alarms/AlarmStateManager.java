...
import com.androidinspain.deskclock.AlarmAlertWakeLock;
import com.androidinspain.deskclock.AlarmClockFragment;
import com.androidinspain.deskclock.AlarmUtils;
import com.androidinspain.deskclock.AsyncHandler;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "com.androidinspain.deskclock.ALARM_CHANGED";
    ...
    public static void setFiredState(Context context, AlarmInstance instance) {
        ...
        Events.sendAlarmEvent(com.androidinspain.deskclock.R.string.action_fire, 0);
            ...
            final Runnable myRunnable = new Runnable() {
                ...
                public void run() {
                    String displayTime = String.format(context.getResources().getQuantityText
                            (com.androidinspain.deskclock.R.plurals.alarm_alert_snooze_set, snoozeMinutes).toString(),
                            snoozeMinutes);
    ...
    public static void handleIntent(Context context, Intent intent) {
        ...
        if (CHANGE_STATE_ACTION.equals(action)) {
            ...
            if (intent.getBooleanExtra(FROM_NOTIFICATION_EXTRA, false)) {
                if (intent.hasCategory(ALARM_DISMISS_TAG)) {
                    Events.sendAlarmEvent(com.androidinspain.deskclock.R.string.action_dismiss, com.androidinspain.deskclock.R.string.label_notification);
                } else if (intent.hasCategory(ALARM_SNOOZE_TAG)) {
                    Events.sendAlarmEvent(com.androidinspain.deskclock.R.string.action_snooze, com.androidinspain.deskclock.R.string.label_notification);
                }
            }
