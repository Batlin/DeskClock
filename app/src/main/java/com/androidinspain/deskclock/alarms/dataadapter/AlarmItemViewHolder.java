...
package com.androidinspain.deskclock.alarms.dataadapter;
...
import com.androidinspain.deskclock.ItemAnimator;
...
public abstract class AlarmItemViewHolder extends ItemAdapter.ItemViewHolder<AlarmItemHolder>
    ...
    public AlarmItemViewHolder(View itemView) {
        ...
        clock = (TextTime) itemView.findViewById(com.androidinspain.deskclock.R.id.digital_clock);
        onOff = (CompoundButton) itemView.findViewById(com.androidinspain.deskclock.R.id.onoff);
        arrow = (ImageView) itemView.findViewById(com.androidinspain.deskclock.R.id.arrow);
        preemptiveDismissButton =
                (TextView) itemView.findViewById(com.androidinspain.deskclock.R.id.preemptive_dismiss_button);
    ...
    protected boolean bindPreemptiveDismissButton(Context context, Alarm alarm,
        ...
        if (canBind) {
            ...
            final String dismissText = alarm.instanceState == AlarmInstance.SNOOZE_STATE
                    ? context.getString(com.androidinspain.deskclock.R.string.alarm_alert_snooze_until,
