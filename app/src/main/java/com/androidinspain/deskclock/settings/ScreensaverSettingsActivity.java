...
public final class ScreensaverSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.androidinspain.deskclock.R.layout.screensaver_settings);
    }
    ...
    public static class PrefsFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            addPreferencesFromResource(com.androidinspain.deskclock.R.xml.screensaver_settings);
        }
