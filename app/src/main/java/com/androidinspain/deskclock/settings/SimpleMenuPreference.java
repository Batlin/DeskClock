...
public class SimpleMenuPreference extends DropDownPreference {
    ...
    public SimpleMenuPreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.androidinspain.deskclock.R.attr.dropdownPreferenceStyle);
    }
    ...
    protected ArrayAdapter createAdapter() {
        mAdapter = new SimpleMenuAdapter(getContext(), com.androidinspain.deskclock.R.layout.simple_menu_dropdown_item);
        return mAdapter;
    }
    ...
    private final static class SimpleMenuAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getDropDownView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (position == 0) {
                view.setBackgroundColor(ContextCompat.getColor(getContext(), com.androidinspain.deskclock.R.color.white_08p));
            } else {
                view.setBackgroundColor(ContextCompat.getColor(getContext(), com.androidinspain.deskclock.R.color.transparent));
            }
            return view;
        }
    }
