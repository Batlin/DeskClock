...
package com.androidinspain.deskclock.widget;
...
public class CircleView extends View {
    ...
    public CircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, com.androidinspain.deskclock.R.styleable.CircleView, defStyleAttr, 0 /* defStyleRes */);

        mGravity = a.getInt(com.androidinspain.deskclock.R.styleable.CircleView_android_gravity, Gravity.NO_GRAVITY);
        mCenterX = a.getDimension(com.androidinspain.deskclock.R.styleable.CircleView_centerX, 0.0f);
        mCenterY = a.getDimension(com.androidinspain.deskclock.R.styleable.CircleView_centerY, 0.0f);
        mRadius = a.getDimension(com.androidinspain.deskclock.R.styleable.CircleView_radius, 0.0f);

        mCirclePaint.setColor(a.getColor(com.androidinspain.deskclock.R.styleable.CircleView_fillColor, Color.WHITE));
     ...
     * @see com.androidinspain.deskclock.R.styleable#CircleView_android_gravity
     */
     ...
     * @return this object, allowing calls to methods in this class to be chained
     * @see com.androidinspain.deskclock.R.styleable#CircleView_fillColor
     */
     ...
     * @return this object, allowing calls to methods in this class to be chained
     * @see com.androidinspain.deskclock.R.styleable#CircleView_centerX
     */
     ...
     * @return this object, allowing calls to methods in this class to be chained
     * @see com.androidinspain.deskclock.R.styleable#CircleView_centerY
     */
     ...
     * @return this object, allowing calls to methods in this class to be chained
     * @see com.androidinspain.deskclock.R.styleable#CircleView_radius
     */
